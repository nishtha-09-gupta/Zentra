...
const faqs = [
  {
    question: "1. What is Zentra?",
    answer: "Zentra is an online platform that allows users to discover, book, and manage events gracefully in one place, whether personal or professional."
  },
  {
    question: "2. How do I book an event on Zentra?",
  ...
  },
  {
    ...
    answer: "Yes. Zentra allows organizers to create, customize, and manage their events, including ticketing, scheduling, and attendee tracking."
  },
  {
    question: "4. Is Zentra suitable for both small and large events?",
  ...
  {
    question: "5. Are payments on Zentra secure?",
    ...
    <main className="relative min-h-screen bg-[#070707] text-[#dcdcdc] font-sans selection:bg-[#b49b5c]/30">
      ...
      <section className="relative h-[100vh] flex flex-col items-center justify-center text-center px-4 overflow-hidden bg-[#070707]">
        ...
        >
          ...
          >
             Zentra is the premier ecosystem for booking, orchestrating, and experiencing world-class gatherings.
          </motion.p>
      ...
      <section className="relative w-full py-32 px-4 flex flex-col items-center justify-center text-center bg-[#070707] overflow-hidden">
        ...
        >
          ...
          <p className="pt-8 text-sm md:text-lg text-[#8a8a8a] leading-relaxed max-w-3xl mx-auto font-light">
            Zentra is a modern event booking and management platform designed to simplify how people plan, organize, and experience events. We bring together seamless booking, smart management tools, and a user-friendly interface to help individuals and organizations create individuals to memorable experiences with ease. Whether it&apos;s a small gathering or a large-scale event, Zentra ensures every detail is handled efficiently, making event planning stress-free and accessible for everyone.
          </p>
        </motion.div>
      </section>
