...
![Class Diagram — Zentra](docs/diagrams/class-diagram.png)

---

### Use Case Diagram

The use case diagram captures all actor interactions with the system, including Guest browsing, Authenticated User actions (hosting events, booking, orders), and system-level integrations like NextAuth providers.

![Use Case Diagram — Zentra](docs/diagrams/usecase-diagram.png)
...
![ER Diagram — Zentra](docs/diagrams/er-diagram.png)
...
CREATE INDEX IF NOT EXISTS idx_student_user_email 
ON student_verifications(user_email);
```
